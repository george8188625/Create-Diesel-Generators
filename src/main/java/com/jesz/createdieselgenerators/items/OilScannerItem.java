            ...
            if(stack.getTag().getInt("Type") == 0) {
                    ...
                    if(level instanceof ServerLevel) {
                        if (stack.getTag().getInt("Time") == 0) {
                            ...
                            else if (entity.level().getBiome(new BlockPos((entity.getBlockX() / 16) * 16, 64, (entity.getBlockZ() / 16) * 16)).is(AllTags.optionalTag(ForgeRegistries.BIOMES, new ResourceLocation("createdieselgenerators:oil_biomes"))))
